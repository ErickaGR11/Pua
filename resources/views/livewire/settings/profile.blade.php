...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Perfil')" :subheading="__('Actualiza tus datos de perfil.')">
        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-6">
            <flux:input wire:model="name" :label="__('Nombre')" type="text" required autofocus autocomplete="name" />
            <flux:input wire:model="phone" :label="__('Celular')" type="text" required autocomplete="phone" />
                    ...
                    <div>
                        <flux:text class="mt-4">
                            ...
                            <flux:link class="text-sm cursor-pointer" wire:click.prevent="resendVerificationNotification">
                                {{ __('Click aquí para re-enviar la verificación del correo.') }}
                            </flux:link>
                        </flux:text>
